...
public class MainCaf extends AppCompatActivity {
    ...
    Button Back;
    String data[] = {"Выход","Ректорат","Кафе","Кафедра станков", "Кафедра философии", "Кафедра теоретической механики и сопротивления материалов",
            "Кафедра технологии машиностроения", "Кафедра экономики и управления предприятием",
